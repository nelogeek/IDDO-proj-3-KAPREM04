...
public class BuildingsOil_Inj2 : MonoBehaviour
{
    ...
    {
        if (BuildingsGrid_KAPREM.csdKey)
        {
    ...
    private void Update()
    {
        if (!InputManager.isPaused)
        {
            ...
            {
                if (BuildingsGrid_KAPREM.fpKey && BuildingsGrid_KAPREM.csdKey && BuildingsGrid_KAPREM.ctiKey && btnInj.interactable == false)
                {
                    btnInj.interactable = true;
                }
                else if (!BuildingsGrid_KAPREM.fpKey && !BuildingsGrid_KAPREM.csdKey && btnInj.interactable == true || !BuildingsGrid_KAPREM.ctiKey)
                {
    ...
    {
        if (BuildingsGrid_KAPREM.fpKey && BuildingsGrid_KAPREM.csdKey)
        {
            available = true;
        }
    }
